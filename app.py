...
if uploaded_file is not None:
    ...
    if metadata.get("gps_latitude") and metadata.get("gps_longitude"):
        ...
        st.info("GPS coordinates not found in metadata; skipping OSM intelligence.")
    ...
    if st.button("Generate PDF Report"):
        report_path = generate_pdf_report(upload_path, metadata, consistency_results, score, label)
